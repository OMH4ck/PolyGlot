...
def generate_token_file(token_list, symbols, prec_info):
    ...
    ban_list = []
    type_dict = {'HEXLITERAL':'sval', "HEXNUNBERLITERAL":"sval", "PRAGMALITERAL": "sval", "IDENTIFIER": "sval", "OP": "sval", "INTLITERAL":"ival", "FLOATLITERAL":"fval", "STRINGLITERAL":"sval", "FIXTYPE": "sval", "EXPONLITERAL":"sval"}
